...
namespace WebApp.Pages
{
    public class ListtoListModel : PageModel
    {
        ...
        public void OnPostAddItem()
        {
            ...
            // If this was taken out, the drop down list would not be generated on the change
            Warmth = _aboutservices.ColorWarmth();
            //default is remain on page if return datatype is void instead of IActionResult
